...
async function main(): Promise<void> {
  ...
  // Tiny metadata in its own module so the app can import it STATICALLY (it's rendered in Settings)
  // without dragging the heavy board data into the main bundle chunk.
  writeFileSync(
  ...
  // Heavy board data, loaded LAZILY via dynamic import (see levelLoader.ts) so it lands in its own
  // chunk instead of the main bundle. Keep it free of any export the app imports statically.
  writeFileSync(
